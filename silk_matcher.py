...
import numpy as np
from utils import dual_softmax_matcher, to_pixel_coords, to_normalized_coords

class DualSoftMaxMatcher(nn.Module):        
    @torch.inference_mode()
    def match(self, keypoints_A, descriptions_A, 
              keypoints_B, descriptions_B, normalize = False, inv_temp = 20,
              threshold = 0.01):
        ...
        # Here threshold of 0.01 should correspond to 0.99 distance as used in kaggle notebook
